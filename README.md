# RNN_implementation
I learned how simple RNN(Recurrent Neural  Network) works
...
git clone https://github.com/yourusername/rnn-text-classifier.git
cd rnn-text-classifier
...
They maintain a memory of previous inputs, making them suitable for:
Text classification
Sentiment analysis
Language modeling
